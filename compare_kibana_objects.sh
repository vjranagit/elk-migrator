...
compare_saved_objects_detailed() {
    echo -e "\n${YELLOW}=== Analyzing Kibana Saved Objects (Detailed per Space) ===${NC}"
...
# Then compare objects within each space
compare_saved_objects_detailed
